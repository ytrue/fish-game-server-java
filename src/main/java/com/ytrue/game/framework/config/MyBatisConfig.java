 ...
 */
@Configuration
@MapperScan(basePackages = {"com.ytrue.game.common.dao.data.mapper", "com.ytrue.game.business.*.data"})
@MapperScan(basePackages = {"com.ytrue.game.common.dao.log.mapper", "com.ytrue.game.business.*.log"},
